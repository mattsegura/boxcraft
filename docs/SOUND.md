...
This document explains Boxcraft's audio architecture, including synthesized sounds and spatial audio positioning.

## Overview

Boxcraft uses **Tone.js** for programmatic sound synthesis. No audio files are needed - all sounds are generated in real-time using Web Audio API.
...
- **Storage**: `localStorage.getItem('boxcraft-spatial-audio')`
- **Default**: Enabled
