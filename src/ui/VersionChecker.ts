 ...
 * (from version.json on boxcraft.sh). Shows a non-intrusive banner if
...
export async function checkForUpdates(): Promise<void> {
  ...
  if (params.has('testUpdate') || params.has('testUpdateCritical')) {
    ...
    const fakeVersionInfo: VersionInfo = {
      ...
      releaseUrl: 'https://github.com/nearcyan/boxcraft/releases',
      updateCommand: 'npx boxcraft@latest setup',
    }
  ...
  try {
    ...
    // In production, it comes from boxcraft.sh
